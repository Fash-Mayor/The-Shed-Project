...
#yt_dlp error handling
############################################Trying to use yt-dlp the way Iuse it in cmd####################################
Window.size = (500, 600)
...
class YoutubeDownloaderApp(App):
    ...
    def build(self):
        ...
        #widgets
        self.img = Image(source = "yt-text-logo.png", size_hint = (.5, .5), pos_hint = {"center_x": 0.5, "center_y": 0.86})

        self.youtubelink = Label(text = "Paste Youtube Link:", pos_hint = {"center_x": 0.5, "center_y": 0.7}, size_hint = (2, 2), 
                                font_size = 20, color = (1, 5, 2))

        self.linkinput = TextInput(text = "", pos_hint = {"center_x": 0.5, "center_y": 0.64}, size_hint = (0.85, 0.06),
                                  height = 36, font_size = 16, foreground_color = (0, 0, 5), font_name = "Verdana")

        self.linkbutton = Button(text = "Get Link", pos_hint = {"center_x" : 0.5, "center_y": 0.55}, size_hint = (0.2, 0.09), 
                                font_name = "Tahoma", font_size = 17, background_color = [0, 1, 0], on_press = self.getLinkInfo)
        ...
        self.lengthLabel = Label(text = "", pos_hint = {"center_x" : 0.5, "center_y" : 30}, size_hint = (1, 1), font_size = 20)
        
        self.downloadButton = Button(pos_hint = {"center_x" : 0.5, "center_y" : 20}, size_hint = (0.2, 0.1), size = (75, 75), 
                                    font_name = "Verdana", bold = True, font_size = 24, background_color =  (1, 1, 0),
